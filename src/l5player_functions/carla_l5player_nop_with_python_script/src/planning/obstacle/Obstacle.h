...
class Obstacle {
   public:
    ...
    const Prediction::Ob_Trajectory &Trajectory() const { return trajectory_; }

    void SetTrajectory(const Prediction::Ob_Trajectory trajectory) { trajectory_ = trajectory; }

    Obstacle_avoid *const GetOba() { return &oba; }
