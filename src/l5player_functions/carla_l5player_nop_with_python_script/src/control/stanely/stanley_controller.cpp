...
namespace l5player {
    namespace control {
        ...
        void StanleyController::ComputeControlCmd(const VehicleState &vehicle_state, const TrajectoryData &planning_published_trajectory, ControlCmd &cmd) 
        {
            ...
            TrajectoryPointOri current_closest_point = this->QueryNearestPointByPosition(current_vehicle_x, current_vehicle_y); // 得到距离最近的路径点的信息
        ...
        {
            TrajectoryPointOri current_closest_point = this->QueryNearestPointByPosition(x, y); // 得到距离最近的路径点的信息
        ...
        TrajectoryPointOri StanleyController::QueryNearestPointByPosition(const double x, const double y) 
        {
