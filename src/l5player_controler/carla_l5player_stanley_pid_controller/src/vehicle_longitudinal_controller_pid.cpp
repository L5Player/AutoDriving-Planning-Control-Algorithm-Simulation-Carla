#include "carla_l5player_stanley_pid_controller/vehicle_longitudinal_controller_pid.h"

#include <math.h>

#include <fstream>

#include "carla_l5player_stanley_pid_controller/common.h"

using namespace std;

static const rclcpp::Logger LOGGER = rclcpp::get_logger("carla_l5player_stanley_pid_controller_publisher");


VehicleControlPublisher::VehicleControlPublisher()
    : Node("carla_l5player_stanley_pid_controller")
/*'''**************************************************************************************
- FunctionName: None
- Function    : None
- Inputs      : None
...
**************************************************************************************'''*/
{
    ...
    pid_controller_longitudinal = std::make_unique<l5player::control::PIDController>(0.16, 0.02, 0.01);
    stanely_controller_lateral = std::make_unique<l5player::control::StanleyController>();
    ...
    // 读取参考线路径
    std::ifstream infile("src/l5player_controler/carla_l5player_stanley_pid_controller/data/2022_09_29_16_27_08_ins_data_map_after_preprocess.csv", ios::in);    //将文件流对象与文件连接起来
