...
class ManualControl(CompatibleNode):
    ...
    def __init__(self, resolution):
        ...
        self._surface = None
        print(self.get_param("role_name", "ego_vehicle"))
...
class HUD(object):
    ...
    def update_info_text(self):
        ...
        time = str(timedelta(seconds=self.node.get_time()))[:10]
        ...
        # print('******************Speed:   % 15.2f km/h' % (self.vehicle_status.velocity))
        self._info_text += [
...
def main(args=None):
    ...
    try:
        display = pygame.display.set_mode((resolution['width'], resolution['height']),pygame.HWSURFACE | pygame.DOUBLEBUF)
        ...
        manual_control_node.hud.csv_writer.close_csv() # TODO 
        roscomp.shutdown()
        spin_thread.join()
        pygame.quit()
