...
class L5playerControl(CompatibleNode):
    ...
    """
    def __init__(self):
        super(L5playerControl, self).__init__("L5playerControl")
...
def main(args=None):
    ...
    main function
    """
    roscomp.init("L5playerControl", args=args)

    try:
        l5player_control_node = L5playerControl()
        executor = roscomp.executors.MultiThreadedExecutor()
        executor.add_node(l5player_control_node)
        update_timer = l5player_control_node.new_timer(0.01, lambda timer_event=None: l5player_control_node._on_new_carla_frame())
        target = l5player_control_node.spin()
